...
export function NavbarClient({ locale, darkText = false }: NavbarClientProps) {
        ...
        <>
            <nav className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
                    ...
                    <Link
                        href={`/${locale}`}
                        className={`flex items-center gap-2 font-extrabold text-xl tracking-tight hover:opacity-80 transition-opacity ${darkText ? 'text-white' : 'text-[#1A1A2E]'}`}
                    >
